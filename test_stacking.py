...
from sklearn.ensemble import AdaBoostClassifier, StackingClassifier, BaggingClassifier, RandomForestClassifier
...
def build_stacking_model(random_state=42):
    ...
    base_estimators = [
        ...
        ('random', RandomForestClassifier(random_state=random_state))
    ]
